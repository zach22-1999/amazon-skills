...
description: 功能需求真伪验证器。面向亚马逊产品开发中的微创新判断，用 Review 信号、关键词信号、社区信号验证某个功能点是真需求还是伪需求。优先调用 Sorftime MCP；若没有 Sorftime，也支持通过本地 review_source_pack 先完成 Review 维度验证。
